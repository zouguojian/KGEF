...
class Experiment:
    ...
    def train_and_eval(self):
        ...
        for it in range(1, self.num_iterations + 1):
            ...
            if it%2==0:
                er_vocab=er_vocab2
                er_vocab_pairs=er_vocab_pairs2
            else:
                er_vocab=er_vocab1
            ...
            entity_neighbours_relations = entity_neighbours_relations1
            entity_neighbours_relations1 = entity_neighbours_relations2
            entity_neighbours_relations2 = entity_neighbours_relations
...
if __name__ == '__main__':
    ...
    experiment = Experiment(model_name, num_iterations=800, batch_size=16, learning_rate=0.001,
                            decay_rate=0.99, ent_vec_dim=512, rel_vec_dim=512, cuda=False,
